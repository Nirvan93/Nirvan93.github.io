//document.writeln("<script type='text/javascript' src='javascript/CSSAnimation.jQuery.js'></script>");
//document.writeln("<script type='text/javascript' src='javascript/CSSAnimation.js'></script>");
...
$(document).ready(function() 
{
	...
	function shardedButton(cols, rows, width, height, link, name)
	{
		...
		{ 
			$('html, body').animate({
				scrollTop: $("#sec"+id.name).offset().top
			}, 2000, 'easeInOutCubic');
