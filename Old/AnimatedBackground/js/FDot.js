function Instance_ParticleDot(instance)
	{
		...
		instance.GetChainLength = function()
		{
			...
			var ni = instance;
			 ...
			 {
				 l += SqrtDistance(ni.lastX, ni.lastY, ni.nearest.lastX, ni.nearest.LastY);
				 ni = ni.nearest;
			 }
			...
			{
				l += SqrtDistance(ni.lastX, ni.lastY, ni.parent.lastX, ni.parent.LastY);
				ni = ni.parent;
			}
		...
		instance.FindNearest = function(instances)
		{
			...
			{
				//if (instance.GetChainLength() > 100 ) return;
		...
		instance.Draw = function()
		{
			...
			i.alpha = Lerp(255,  50 + Math.round( Math.sin(i.counter*1.23)*50 ), Math.sqrt(distanceFactorUnsquared) );
